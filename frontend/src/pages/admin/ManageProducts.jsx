...
const ManageProducts = () => {
    ...
    const resetForm = () => {
        ...
        setExistingImages([]); setExistingVideo(null); setNewImagePreviews([]);
    };
    ...
    const handleEdit = (prod) => {
        ...
        setFormData({
            ...
            is_trending: prod.is_trending == 1 || prod.is_trending === true, 
            status: prod.status == 1 || prod.status === true
        });
                ...
                <form onSubmit={handleSubmit}>
                    <div className="row g-4">
                        ...
                        <div className="col-md-6">
                            ...
                            <input type="file" className="form-control rounded-pill p-2 border-0 bg-light fw-bold" multiple onChange={handleImageChange} accept="image/*" />
                            
                            {/* New Previews */}
                            {newImagePreviews.length > 0 && (
                                <div className="mt-2">
                                    <p className="x-small fw-bold text-primary mb-1">New Selection:</p>
                                    <div className="d-flex gap-2 overflow-auto pb-2">
                                        {newImagePreviews.map((preview, i) => (
                                            <img key={i} src={preview} height="60" className="rounded border shadow-sm" />
                                        ))}
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="col-md-6">
                            ...
                            {editingId && existingVideo && (
                                <div className="mt-2 small fw-bold text-success d-flex align-items-center">
                                    <i className="bi bi-check-circle-fill me-2"></i>Current Video Linked
                                </div>
                            )}
                        </div>
