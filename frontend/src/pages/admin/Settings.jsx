                            ...
                            <div className="row g-4">
                                <div className="col-12">
                                    ...
                                    <div className="d-flex align-items-center gap-4 bg-light p-3 rounded-4">
                                        <img src={currentLogo ? `/storage/${currentLogo}` : 'https://via.placeholder.com/100x40'} style={{maxHeight:'40px'}} className="rounded" />
                                ...
                                <div className="col-12">
                                    ...
                                    <div className="d-flex align-items-center gap-4 bg-light p-3 rounded-4">
                                        <img src={currentFavicon ? `/storage/${currentFavicon}` : 'https://via.placeholder.com/32'} style={{width:'32px', height:'32px'}} className="rounded shadow-sm" />
