                                ...
                                <tr key={item.id}>
                                    <td>
                                        <div className="d-flex align-items-center gap-3">
                                                                                         <img src={item.product?.images?.[0]?.startsWith('http') ? item.product.images[0] : `/storage/${item.product?.images?.[0]}`} className="rounded-3 shadow-sm" width="50" height="50" style={{objectFit: 'cover'}} />                                            <span className="fw-bold">{item.product?.name}</span>
                                        </div>
                                    </td>
