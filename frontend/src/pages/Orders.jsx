                                    ...
                                    {order.order_items?.map(item => (
                                        <div className="col-md-4" key={item.id}>
                                            <div className="d-flex align-items-center gap-3">
                                                <img src={item.product?.images?.[0] ? (item.product.images[0].startsWith('http') ? item.product.images[0] : `http://localhost:8000/storage/${item.product.images[0]}`) : 'https://via.placeholder.com/60'} className="rounded-3 shadow-sm" width="60" height="60" style={{objectFit: 'cover'}} />
                                                <div>
